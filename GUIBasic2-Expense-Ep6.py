...
GUI = Tk()
GUI.title('โปรแกรมบันทึกค่าใช้จ่าย by Thinnakorn Jantabate')
...
# Help
def About():
	messagebox.showinfo('About','สวัสดีครับโปรแกรมนี้เป็นโปรแกรมบันทึกรายรับรายจ่ายฟรี\nแต่สามารถสนับสนุน\nการโดเนทเพื่อการอัพเดทต่อๆไปได้')
helpmenu = Menu(menubar,tearoff=0)
menubar.add_cascade(label='Help',menu=helpmenu)
helpmenu.add_command(label='About',command=About) ##เพื่อเชื่อมข้อมูลที่ต้องการแสดง
# Donate
def Donate():
	messagebox.showinfo('Donate','Prompay: 0962172781')
...
resulttable = ttk.Treeview(T2,columns=header,show='headings',height=20) ##เพิ่มขนาดของที่ใส่ข้อมูล
resulttable.pack()
...
def update_table():
	resulttable.delete(*resulttable.get_children()) ##เอาไว้ลบค่า
